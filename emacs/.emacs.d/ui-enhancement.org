...
#+BEGIN_SRC emacs-lisp
  (setq hesam-default-font-family "IosevkaTerm Nerd Font"
        hesam-default-hires-height 180
        hesam-default-lowres-height 120
        hesam-modeline-hires-height (- hesam-default-hires-height 10)
        hesam-modeline-lowres-height (- hesam-default-lowres-height 5))
...
#+BEGIN_SRC emacs-lisp
  (advice-add
   'tab-bar-format-tabs
   :around
   (lambda (orig-fun) (cdr (funcall orig-fun))))
#+END_SRC
...
frame to separate the tab bar from the buffer.
#+BEGIN_SRC emacs-lisp
