...
#+BEGIN_SRC emacs-lisp
  ...
  (require 'exwm-config)
  (exwm-config-default)
  (ido-mode -1)				; (exwm-default-config) loads ido
...
** appearance
#+BEGIN_SRC emacs-lisp
  (run-at-time "04:00" 86400 #'hesam/switch-theme-light)
  (run-at-time "04:00" 86400 #'hesam/day)
  (run-at-time "18:00" 86400 #'hesam/switch-theme-dark)
  (run-at-time "20:00" 86400 #'hesam/night)
#+END_SRC
* minions
