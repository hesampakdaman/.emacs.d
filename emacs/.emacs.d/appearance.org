...
#+BEGIN_SRC emacs-lisp
  ...
  (dolist (frame-option '((undecorated . t) (internal-border-width . 10) (drag-internal-border . 1)))
...
#+BEGIN_SRC emacs-lisp
  (set-face-attribute 'mode-line-inactive nil
                      :background (eval 'dracula-bg)
                      :foreground (eval 'dracula-bg)
                      :underline (list :color (eval 'dracula-current) :style 'line)
                      :height 1
                      :box nil)
#+END_SRC
