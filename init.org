...
#+begin_src emacs-lisp
  ...
  (defun hesam/set-font-from-dpi (frame)
    ...
    (hesam/apply-font-to-frame (selected-frame))

    ;; Apply when creating frames
    (add-hook 'after-make-frame-functions #'hesam/apply-font-to-frame)

    ;; Re-evaluate when frame size/monitor changes
    (add-hook 'window-size-change-functions
              (lambda (_frame)
                (hesam/set-font-from-dpi (selected-frame))))
#+end_src
*** Ligatures
